...
def main(start_time):
    ...
    stock_option_1_back = pygame.Rect(30, 39, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_2_back = pygame.Rect(30, 109, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_3_back = pygame.Rect(30, 179, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_4_back = pygame.Rect(30, 249, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_5_back = pygame.Rect(30, 319, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))

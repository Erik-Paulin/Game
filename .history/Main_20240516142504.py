...
def stock(elapsed_time, days, secs_per_day, cost):
    if int(elapsed_time)/secs_per_day > days:
        print (float(cost)*(random.uniform(0.90,1.15),2))
        return (float(cost)*(random.uniform(0.90,1.15),2))
...
def main(start_time):
    ...
    while run:
        ...
        cost_a = stock(elapsed_time, days, secs_per_day, cost_ok)
        stock(elapsed_time, days, secs_per_day, cost_b)
        stock(elapsed_time, days, secs_per_day, cost_c)
        stock(elapsed_time, days, secs_per_day, cost_d)
        stock(elapsed_time, days, secs_per_day, cost_e)
        stock(elapsed_time, days, secs_per_day, cost_f)

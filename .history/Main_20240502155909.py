...
def stock(elapsed_time, days, secs_per_day, cost):
    if int(elapsed_time)/secs_per_day > days:
        return (cost*random.randint(0.90,1.15))
    return cost
...
def main(start_time):
    ...
    while run:
        ...
        cost_a = stock(elapsed_time, days, secs_per_day, cost_a)
        cost_b = stock(elapsed_time, days, secs_per_day, cost_b)
        cost_c = stock(elapsed_time, days, secs_per_day, cost_c)
        cost_d = stock(elapsed_time, days, secs_per_day, cost_d)
        cost_e = stock(elapsed_time, days, secs_per_day, cost_e)
        cost_f = stock(elapsed_time, days, secs_per_day, cost_f)
        ...
        if in_store:
            draw_menu(store_back, elapsed_time, days, money, cost_a, cost_b, cost_c, cost_d, cost_e, cost_f, estock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5, stock_option_6, stock_option_1_back, stock_option_2_back, stock_option_3_back, stock_option_4_back, stock_option_5_back, stock_option_6_back)    

...
def main(start_time):
    ...
    stock_option_2_back = pygame.Rect(30, 110, STOCK_OPTION_WIDTH, (STOCK_OPTION_HEIGHT+1))
    stock_option_3_back = pygame.Rect(30, 180, STOCK_OPTION_WIDTH, (STOCK_OPTION_HEIGHT+1))

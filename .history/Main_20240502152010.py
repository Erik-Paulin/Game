...
def draw_menu(store_back, elapsed_time, days, money, stock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5, stock_option_1_back, stock_option_2_back, stock_option_3_back, stock_option_4_back, stock_option_5_back):
    ...
    pygame.draw.rect(WIN, "black", stock_option_1_back)
    pygame.draw.rect(WIN, "black", stock_option_2_back)
    pygame.draw.rect(WIN, "black", stock_option_3_back)
    pygame.draw.rect(WIN, "black", stock_option_4_back)
    pygame.draw.rect(WIN, "black", stock_option_5_back)

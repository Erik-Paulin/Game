    ...
    while run:
        ...
        if in_store:
            ...
            if keys[pygame.K_q] and own_a>0:
                own_a -=1
                money += cost_a
            if keys[pygame.K_2] and own_b>0:
                own_b +=1      
                money -= cost_b          
            if keys[pygame.K_3] and own_c >0:
                own_c +=1      
                money -= cost_c       
            if keys[pygame.K_4] and own_d >0:
                own_d +=1 
                money -= cost_d
            if keys[pygame.K_5] and own_e >0:
                own_e +=1     
                money -= cost_e        
            if keys[pygame.K_5] and own_f >0:
                own_f +=1
                money -= cost_f                              

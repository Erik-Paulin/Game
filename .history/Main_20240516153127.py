...
def main(start_time):
    ...
    while run:
        ...
        if in_store:
            if keys[pygame.K_f]:
                in_store = False
            if keys[pygame.K_1] and money > cost_a:
                own_a +=1
                money -= cost_a
                buy += 100
            if keys[pygame.K_2] and money > cost_b:
                own_b +=1      
                money -= cost_b
                buy += 100
            if keys[pygame.K_3] and money > cost_c:
                own_c +=1      
                money -= cost_c
                buy += 100
            if keys[pygame.K_4] and money > cost_d:
                own_d +=1 
                money -= cost_d
                buy += 100
            if keys[pygame.K_5] and money > cost_e:
                own_e +=1     
                money -= cost_e
                buy += 100
            if keys[pygame.K_5] and money > cost_f:
                own_f +=1
                money -= cost_f
                buy += 100
            
            if keys[pygame.K_q] and own_a>0:
                own_a -=1
                money += cost_a
                buy += 100
            if keys[pygame.K_w] and own_b>0:
                own_b -=1      
                money += cost_b
                buy += 100
            if keys[pygame.K_e] and own_c>0:
                own_c -=1      
                money += cost_c
                buy += 100
            if keys[pygame.K_r] and own_d>0:
                own_d -=1 
                money += cost_d
                buy += 100
            if keys[pygame.K_t] and own_e>0:
                own_e -=1     
                money += cost_e
                buy += 100
            if keys[pygame.K_y] and own_f>0:
                own_f -=1
                money += cost_f
                buy += 100

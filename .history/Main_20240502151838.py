...
def main(start_time):
    ...
    while run:
        ...
        if in_store:
            draw_menu(store_back, elapsed_time, days, money, stock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5, stock_option_1_back, stock_option_1_back, stock_option_1_back, stock_option_1_back)    

...
def main(start_time):
    ...
    while run:
        ...
        if int(elapsed_time)/secs_per_day > days:
            ...
            cost_a = stock(elapsed_time, days, secs_per_day, cost_c)
            cost_a = stock(elapsed_time, days, secs_per_day, cost_d)
            cost_a = stock(elapsed_time, days, secs_per_day, cost_e)
            cost_a = stock(elapsed_time, days, secs_per_day, cost_f)

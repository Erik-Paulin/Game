...
def main(start_time):
    ...
    stock_option_2 = pygame.Rect(30, 90, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_3 = pygame.Rect(30, 140, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_4 = pygame.Rect(30, 190, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_5 = pygame.Rect(30, 240, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)

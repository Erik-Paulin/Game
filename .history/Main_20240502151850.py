...
def draw_menu(store_back, elapsed_time, days, money, stock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5):
    WIN.blit(BG, (0, 0))
...
def main(start_time):
    ...
    stock_option_1 = pygame.Rect(30, 40, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_2 = pygame.Rect(30, 110, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_3 = pygame.Rect(30, 180, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_4 = pygame.Rect(30, 250, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_5 = pygame.Rect(30, 320, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)

    stock_option_1_back = pygame.Rect(29, 39, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_2_back = pygame.Rect(29, 109, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_3_back = pygame.Rect(29, 179, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_4_back = pygame.Rect(29, 249, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    stock_option_5_back = pygame.Rect(29, 319, (STOCK_OPTION_WIDTH+2), (STOCK_OPTION_HEIGHT+2))
    ...
    while run:
        ...
        if in_store:
            draw_menu(store_back, elapsed_time, days, money, stock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5, stock_option_1_back, stock_option_2_back, stock_option_3_back, stock_option_4_back, stock_option_1_back)    

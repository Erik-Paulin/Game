...
def draw_menu(store_back, elapsed_time, days, money, stock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5):
    ...
    pygame.draw.rect(WIN, "black", stock_option_)
...
def main(start_time):
    ...
    stock_option_1 = pygame.Rect(30, 30, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_2 = pygame.Rect(30, 80, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_3 = pygame.Rect(30, 130, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_4 = pygame.Rect(30, 180, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)
    stock_option_5 = pygame.Rect(30, 230, STOCK_OPTION_WIDTH, STOCK_OPTION_HEIGHT)

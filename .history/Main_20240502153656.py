...
def draw_menu(store_back, elapsed_time, days, money, stock_option_1, stock_option_2, stock_option_3, stock_option_4, stock_option_5, stock_option_1_back, stock_option_2_back, stock_option_3_back, stock_option_4_back, stock_option_5_back):
    ...
    stock_text_2 = FONT.render(f"Company A", 1, "white")
    WIN.blit(stock_text_2, (50, 60))
    stock_text_2_cost = FONT.render(f"Cost: 100", 1, "white")
    WIN.blit(stock_text_2_cost, (300, 60))

    stock_text_3 = FONT.render(f"Company A", 1, "white")
    WIN.blit(stock_text_3, (50, 60))
    stock_text_3_cost = FONT.render(f"Cost: 100", 1, "white")
    WIN.blit(stock_text_3_cost, (300, 60))   

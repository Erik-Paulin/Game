...
def main(start_time):
    ...
    stock_option_1_back = pygame.Rect(30, 39, STOCK_OPTION_WIDTH, (STOCK_OPTION_HEIGHT+1))
    ...
    stock_option_5_back = pygame.Rect(30, 320, STOCK_OPTION_WIDTH, (STOCK_OPTION_HEIGHT+1))
